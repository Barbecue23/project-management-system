...
Devise.setup do |config|
  ...
  # config.secret_key = '8c894b1e85e81deee605822a4ea75bc5e7a8c0e89fd7e4a5b8a933261147ba3ec584a603178cc34991b4f19c8d93b40afd77bc5d3c06578b57f2cffa708fc438'
  ...
  # config.pepper = 'c19784cb9029ba7f3e4c8660ee7595950ad748d86a8112abe83e0533dbd4dcbb79fe3b556fbafccd38e11016b2d172296b35dbcea387e07bb0092fab4a9788c5'
  ...
  config.sign_out_via = :delete
      ...
      config.omniauth :openid_connect, {
        name: :oauth2,
        scope: [ :openid, :email ],  # เพิ่ม scope ตามต้องการ เช่น :profile, :phone ก็ได้
        response_type: :code,
        discovery: true,
        issuer: "https://nidp.su.ac.th/nidp/oauth/nam",
        client_options: {
