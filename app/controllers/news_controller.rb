class NewsController < ApplicationController
    ...
    def new
      ...
      def create
        # Simulating adding a new news article (mocking submission)
        new_news = {
          title: params[:title],
          info: params[:info],
          ...
          banner_image: params[:banner_image].present? ? params[:banner_image] : "loading.svg",
          more_images: params[:more_images] || [],
          createAt: "เพิ่งเพิ่มเมื่อกี้"
        }
